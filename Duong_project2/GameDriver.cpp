...
void printAllInfo(Player players[], int num_players, Board board)
{
    cout<<endl;
...
int main()
{
    ...
    while(winner_found==-1)
    {
        ...
        for(int i=0; i<num_players; i++)
        {
            ...
            if (choice==1) //draw card
            {
                ...
                {
                    cout<<"You're stuck on a gummy candy and must skip a turn."<<endl;
                }
                else if(players[i].getTurnsSkipped()==4)
                {
                    cout<<"You must skip a turn due to the calamity."<<endl;
                }
                ...
                else 
                {
                    ...
                    for(int j=0; j<game.getGummyTiles().size(); j++)
                    {
                        ...
                        {
                            cout<<"You landed on a gummy candy and must skip your next turn."<<endl;
            ...
            else if (choice == 2)
            {
                ...
                if(players[i].getCandyAmount()==0)
                {
                    ...
                    cout<<"you don't have any candy to use."<<endl;
                }
                else if(only_immunity_left==true)
                {
                    cout<<"you only have immunity candies, which you can't directly use."<<endl;
                }
                else
                {
                    string use_candy;
                    cout<<"Here is a list of all your candies:"<<endl;
                    ...
                    {
                        cout<<"You can't directly use an immunity candy. Selected a different candy:"<<endl;
                        cin.clear();
                        getline(cin, use_candy);
    ...
    cout<<"════════════════*.·:·.✧ ✦ ✧.·:·.*════════════════"<<endl;
    cout<<endl;
    cout<<"Congrats, "<<players[winner_found].getName()<<"! You reached the castle first and won!"<<endl;
    cout<<endl;
