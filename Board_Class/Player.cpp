...
void Player::printInventory() const
{
    for(int i=0; i<_MAX_CANDY_AMOUNT; i++)
    {
        ...
        else if(i%3==0)
        {
            ...
            cout<<GREENTEXT<<"["<< _inventory[i].name << "]"<<RESET;
        }
        else
        {
            cout<<GREENTEXT<<"  [" << _inventory[i].name << "]"<<RESET;
...
{
    cout<<ORANGETEXT<<"Name: "<<YELLOWTEXT<< _name<<RESET<<endl;
    cout<<ORANGETEXT<<"Stamina: "<< _stamina<<endl;
    cout<<ORANGETEXT<<"Gold: "<< _gold<<endl;
    cout<<ORANGETEXT<<"Candies: "<<RESET<<endl;
    printInventory(); 
    cout<<endl; 
}
